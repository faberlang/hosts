...
// Keep the established crate::device_host::DeviceSession path while the
// backend-neutral trait lives in host-device-core.
pub use host_device_core::DeviceSession;
